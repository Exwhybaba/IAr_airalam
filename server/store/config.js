...
const defaults = {
  // Backend/IT managed
  INFER_UPSTREAM_URL: process.env.INFER_UPSTREAM_URL || process.env.INFER_URL || 'https://iar-airalam.onrender.com/api/v1/infer',
  INFER_ASSET_BASE: process.env.INFER_ASSET_BASE || 'https://iar-airalam.onrender.com/',
...
try {
  ...
  console.warn('Failed to load settings.json:', err.message)
}
...
export function updateSettings(partial) {
  ...
  try {
    ...
    console.warn('Failed to write settings.json:', err.message)
  }
  return getSettings()
}
